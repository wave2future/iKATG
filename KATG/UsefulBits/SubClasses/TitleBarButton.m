...
@interface TitleBarButton (Private)
- (void)setup;
...
- (void)maskGradient:(CGRect)rect
{
	...
	CGPathMoveToPoint(path, NULL, (CornerRad + inset), inset);
	CGPathAddLineToPoint(path, NULL, rect.size.width - (CornerRad + inset), inset);
	CGPathAddArc(path, NULL, rect.size.width - (CornerRad + inset), (CornerRad + inset), CornerRad, ToRadians(-90), ToRadians(0), false);
	CGPathAddLineToPoint(path, NULL, rect.size.width - inset, rect.size.height - (CornerRad + inset));
	CGPathAddArc(path, NULL, rect.size.width - (CornerRad + inset), rect.size.height - (CornerRad + inset), CornerRad, ToRadians(0), ToRadians(90), false);
...
- (void)maskBounds:(CGRect)rect
{
	...
	CGPathAddLineToPoint(path, NULL, rect.size.width - CornerRad, 0);
	CGPathAddArc(path, NULL, rect.size.width - CornerRad, CornerRad, CornerRad, ToRadians(-90), ToRadians(0), false);
	CGPathAddLineToPoint(path, NULL, rect.size.width, rect.size.height - CornerRad);
	CGPathAddArc(path, NULL, rect.size.width - CornerRad, rect.size.height - CornerRad, CornerRad, ToRadians(0), ToRadians(90), false);
